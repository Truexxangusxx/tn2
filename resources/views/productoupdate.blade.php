...
<script>
    ...
    app.controller('mainCtrl', function ($scope, $http) {
        ...
        $http({
            ...
            $scope.imagen='/buscarimagen?imagen={{$id}}.jpg'
        ...
        $scope.eliminar = function () {
            $http({
                ...
                $scope.producto.id = response.data.producto.id;
                setTimeout(function () {
                    document.getElementById("myform").action="/productonew";
                    document.getElementById("myform").submit();
                }, 500);
...
<div class="row" ng-controller="mainCtrl">
    <div class="col-xs-12 col-md-6">
        ...
        <form action="{{$id}}" method="POST" id="myform" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-default" ng-click="eliminar()"><i class="fa fa-trash"></i> Eliminar</button>
        </form>
        <br>
        <br>
    ...
    <div class="col-md-6">
        ...
        <div ng-repeat="item in data" class="row form-group">
            <div class="col-xs-5">
                <input type="text" name="propiedad" class="form-control" ng-model="item.nombre">
            </div>
            <div class="col-xs-5">
